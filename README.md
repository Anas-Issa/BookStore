...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ec36d990-c8f9-4919-9bb3-9a4ec4bdb5d2
```

> `ec36d990-c8f9-4919-9bb3-9a4ec4bdb5d2` is the password of the certificate, you can change it to any password you want.
